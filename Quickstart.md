## Quickstart - Consumindo Serviços de Backend para um Schema de Dados
...
Se __erro__, a mensagem retornada será semelhante a:
...
Se __erro__, o retorno será HTTP Status 400, com essa mensagem:
